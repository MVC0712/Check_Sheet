...
$(document).on("click", "#insert", function() {
    var fileName = "InsMaintenanceV2.php";
    ...
    if (document.getElementById("file").files.length == 0) {
        ...
        xhttp.open("POST", "FileUploadMultiple.php", true);
        ...
        var InsFileName = "InsFileName.php";
