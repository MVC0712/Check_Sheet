...
function list_content() {
    var fileName = "SelListContentV2.php";
...
function fillTableBody(data, tbodyDom) {
    ...
    data.forEach(function(trVal) {
        ...
        Object.keys(trVal).forEach(function(tdVal) {
            ...
            } else if ((tdVal == "min_value") || (tdVal == "max_value")) {
                $("<td>").append($("<input>").val(trVal[tdVal]).addClass("number-input")).appendTo(newTr);
            } else {
...
$(document).on("click", "#Insert_list_content", function() {
    var fileName = "InsListContentV2.php";
    var sendObj = new Object();
    ...
    sendObj["ins_list_content_min_value"] = $("#ins_list_content_min_value").val();
    sendObj["ins_list_content_max_value"] = $("#ins_list_content_max_value").val();
    ...
    $("#ins_list_content_min_value").val("");
    $("#ins_list_content_min_value").removeClass("complete-input").addClass("no-input");
    $("#ins_list_content_max_value").val("");
    $("#ins_list_content_max_value").removeClass("complete-input").addClass("no-input");
...
$(document).on("change", "#list_content tbody tr td", function () {
    let sendData = new Object();
    let fileName;
    fileName = "UpdateListContentDataV2.php";
    sendData = {
      ...
      min_value : $("#list_content__selected td:nth-child(6) input").val(),
      max_value : $("#list_content__selected td:nth-child(7) input").val(),
    };
    myAjax.myAjax(fileName, sendData);
    list_content();
});
...
function InsContentCheck() {
    if ((($("#ins_list_content_content").val().length == 0)|| 
        ...
        ($("#ins_list_content_min_value").val().length == 0)||
        ($("#ins_list_content_max_value").val().length == 0)||
...
$(document).on("change", "#ins_list_content_type_select", function() {
    if ($(this).val() == 1) {
        $("#ins_list_content_min_value").val("---");
        $("#ins_list_content_min_value").prop("disabled", true);
        $("#ins_list_content_max_value").val("---");
        $("#ins_list_content_max_value").prop("disabled", true);
    } else {
        $("#ins_list_content_min_value").prop("disabled", false);
        $("#ins_list_content_max_value").prop("disabled", false);
    }
    InsCheck();
});
