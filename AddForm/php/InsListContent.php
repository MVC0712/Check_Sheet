...
try {
    $sql = "INSERT INTO t_content(list_check_id, content, check_type_id, description, file_url) VALUES 
        ('$list_check_id,'$ins_list_content_content','$ins_list_content_type','$ins_list_content_description','$file_url')";
